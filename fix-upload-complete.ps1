# PowerShell script to fix Upload Tab with proper emojis and comparison logic
...
Write-Host "Creating new Upload Tab with proper encoding..." -ForegroundColor Cyan

# Use here-string with proper emojis
$newUploadTab = @"
...
[System.IO.File]::WriteAllText("$PWD\public\index.html", $newContent, [System.Text.Encoding]::UTF8)

Write-Host "`n✅ SUCCESS! Upload Tab fixed with proper emojis and comparison logic!" -ForegroundColor Green
Write-Host "`nFeatures added:" -ForegroundColor Yellow
Write-Host "- Sheet selection for multi-sheet Excel files" -ForegroundColor White
Write-Host "- Comparison with existing Firebase data" -ForegroundColor White
Write-Host "- Status badges: 🟢 New | 🟡 Changed | ⚪ Unchanged" -ForegroundColor White
Write-Host "- Proper UTF-8 encoding for all emojis" -ForegroundColor White
